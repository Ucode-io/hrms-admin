...
- Spacing and layout rhythm: the heading block is 72 px high; its lower padding was reduced, weekday headers are 48 px and centered in all seven cells, and the unnecessary top border above them is removed. Calendar mode now cancels the application content padding and fills the entire viewport remainder below the task toolbar.
