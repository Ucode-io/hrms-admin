...
export default function ClientForm() {
  ...
  return (
    <>
      <PageMeta
        title={isEditMode ? t("clients.edit_title") : t("clients.add_title")}
        description={isEditMode ? t("clients.edit_description") : t("clients.add_description")}
      />
      ...
      <div className="mb-6 flex items-center gap-2 text-sm">
        <span className="text-[#B38D80]">{t("clients.breadcrumb")}</span>
        <span className="text-gray-400">/</span>
        <span className="text-gray-800 font-medium">
          {isEditMode ? t("clients.edit") : t("clients.add")}
        </span>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
          ...
          <div className="md:col-span-2">
            <label className="mb-1.5 block text-sm font-medium text-gray-700">
              {t("clients.company_name")} <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-gray-700">
              {t("clients.contact_name")} <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              value={formData.name}
          ...
          <div>
            ...
            <input
              ...
              className={inputClass}
              placeholder={t("clients.manager_placeholder")}
            />
          </div>
