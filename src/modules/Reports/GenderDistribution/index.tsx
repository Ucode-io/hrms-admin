...
import { ArrowLeft, ChevronLeft, ChevronRight, MoreHorizontal, SlidersHorizontal } from "lucide-react";
        ...
        <section className="rounded-2xl border border-gray-200 bg-white">
          <div className="flex items-start justify-between gap-3 border-b border-gray-100 px-4 py-3">
            <div>
              ...
              <h1 className="text-2xl font-semibold text-gray-900">Гендерное распределение</h1>
              <p className="text-xs text-gray-500">Отчет о гендерной диверсификации вашей компании</p>
            </div>
