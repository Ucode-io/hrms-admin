                    ...
                    <table className="min-w-full text-left">
                      <thead>
                        <tr className="border-b border-slate-200">
                          ...
                          <th className="whitespace-nowrap px-2 py-2 first:pl-0 last:pr-0 text-[12px] font-semibold text-slate-500">{t("attendance.request_status")}</th>
                          <th className="whitespace-nowrap px-2 py-2 first:pl-0 last:pr-0 text-[12px] font-semibold text-slate-500">{t("absence_calendar.source.label")}</th>
                          <th className="whitespace-nowrap px-2 py-2 text-[12px] font-semibold text-slate-500">{t("attendance.photo")}</th>
                          ...
                          <th className="whitespace-nowrap px-2 py-2 text-[12px] font-semibold text-slate-500">{t("attendance.comments")}</th>
